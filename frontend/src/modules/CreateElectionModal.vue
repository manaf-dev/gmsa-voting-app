...
<template>
  <div
    class="h-screen w-screen bg-black/50 fixed top-0 left-0 flex items-center justify-center z-50"
  >
    <div class="bg-white rounded-lg p-6 w-full max-w-3xl relative m-4 md:m-6">
      <!-- Close Icon -->
      <!-- This was missing emit -->
      <button
      ...
      <div class="space-y-0">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <!-- <div>
            ...
            <BaseBtn
              class="inline-flex items-center mt-1 gap-2 border-2 border-orange-600 text-orange-600 px-4 py-2 rounded-lg cursor-pointer"
            >
