        ...
        <div class="bg-white rounded-lg shadow p-6 text-center">
          ...
          >
            <button
              ...
              @click="publish"
              class="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-md cursor-pointer"
            >
              Publish Results
            </button>
            <button
            ...
            <button
              @click="printPage"
              class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-md inline-flex items-center gap-2 cursor-pointer"
            >
